...
- `themes/blowfish/` is the theme submodule, `themes/blowfish/layouts/` provides fallbacks for everything not in `layouts/`
...
- `hugo.toml`, `config/`, and `i18n/` define site settings and translations.
